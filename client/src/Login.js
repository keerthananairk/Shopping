...
function SigninForm(){
    ...
    const login=()=>{
        Axios.post('http://localhost:5002/login', {username:username, password:password,
    }).then((response)=>{
    ...
    useEffect(()=>{
      Axios.get("http://localhost:5002/login").then((response)=>{
...
function SignupForm(){
    ...
    const register=()=>{
        Axios.post('http://localhost:5002/register', {username:usernameReg, password:passwordReg,
    }).then((response)=>{
        console.log(response)
    })
    }
